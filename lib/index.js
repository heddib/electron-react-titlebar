...
const TitleBar = exports.TitleBar = ({ children, icon, menu, disableMinimize, disableMaximize, settings, className, currentWindow }) => _react2.default.createElement(
  'div',
  ...
  children,
  _react2.default.createElement(_windowControls.WindowControls, { disableMinimize: disableMinimize, disableMaximize: disableMaximize, settings: settings, currentWindow: currentWindow })
);
...
TitleBar.propTypes = {
  ...
  settings: _propTypes2.default.element,
