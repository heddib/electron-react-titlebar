...
class WindowControls extends _react.Component {
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { 'aria-label': 'settings', tabIndex: '-1', className: 'window-control window-maximize', disabled: !(settings != null),
...
WindowControls.defaultProps = {
  ...
  settings: _react2.default.createElement(_settings.Settings, null)
};